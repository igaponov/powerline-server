...
class UserFollowVoter implements VoterInterface
{
    const DELETE = 'delete';
    ...
    {
        $supportedClass = UserFollow::class;
    ...
    public function vote(TokenInterface $token, $object, array $attributes)
    {
        ...
        if (
        ($attribute === self::APPROVE && $object->getUser()->getId() == $user->getId())
        || ($attribute === self::DELETE && $object->getUser()->getId() == $user->getId()
            || $object->getFollower()->getId() == $user->getId())
        ) {
