...
/**
 * @Route("/user-petition-comments/{id}")
 */
class UserPetitionCommentController extends AbstractCommentController
{
    /**
     ...
     *     output={
     *          "class" = "Civix\CoreBundle\Entity\UserPetition\Comment",
