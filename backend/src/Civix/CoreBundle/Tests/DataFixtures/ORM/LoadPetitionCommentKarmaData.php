 ...
 * LoadUserData.
 */
class LoadPetitionCommentKarmaData extends AbstractFixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        /** @var BaseCommentRate $rate */
        $rate = $this->getReference('petition_comment_3_rate_1');
    ...
    {
        return [LoadUserPetitionCommentRateData::class];
    }
}
