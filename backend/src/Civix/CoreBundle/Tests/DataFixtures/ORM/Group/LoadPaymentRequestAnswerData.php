...
class LoadPaymentRequestAnswerData extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->addReference(
            ...
            $this->createAnswer(
                ...
                $this->getReference('group_payment_request_1')
            )
        );
        $this->addReference(
        ...
        $this->addReference(
            ...
            $this->createAnswer(
                ...
                $this->getReference('group_payment_request_2')
            )
        );
        $this->createAnswer(
            $this->getReference('user_2'),
        ...
        $this->addReference(
            ...
            $this->createAnswer(
                $this->getReference('user_1'),
                $this->getReference('group_payment_request_3')
            )
        );
        $this->createAnswer(
            $this->getReference('user_3'),
    ...
    {
        return [LoadGroupPaymentRequestData::class];
    }
