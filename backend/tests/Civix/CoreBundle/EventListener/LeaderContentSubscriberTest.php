...
class LeaderContentSubscriberTest extends TestCase
{
    ...
    public function testSetPetitionExpire()
    {
        ...
        $this->assertLessThan(new \DateTime('+7192 days + 1 second'), $petition->getExpiredAt());
        $this->assertGreaterThan(new \DateTime('+7192 days - 1 second'), $petition->getExpiredAt());
    }
