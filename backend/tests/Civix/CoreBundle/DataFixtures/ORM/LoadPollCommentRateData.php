...
class LoadPollCommentRateData extends AbstractFixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $comment1 = $this->getReference('poll_comment_1');
        /** @var Comment $comment2 */
        $comment2 = $this->getReference('poll_comment_2');
        /** @var Comment $comment4 */
        $comment4 = $this->getReference('poll_comment_4');
    ...
    {
        return [LoadPollCommentData::class];
    }
}