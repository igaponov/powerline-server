...
class Version20160814122434 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('INSERT INTO user_posts(id, group_id, user_id, body, html_body, created_at, expired_at, user_expire_interval, boosted, cached_hash_tags, metadata) SELECT id, group_id, user_id, petition, petition_body_html, created_at, expire_at, user_expire_interval, publish_status, cached_hash_tags, metadata FROM micropetitions WHERE type = ?', ['quorum']);
